...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" class="row curso-contenedor">
    <div style="background-color:darkslategrey" class:"col-md-6 mb-4">
        ...
        <div class="content-container">
            ...
            <div class="button-container" style="background-color: azure">
                <asp:Panel runat="server" Class="center-horizontal">
                    <asp:Button ID="btnVerUsuarios" CssClass="btn btn-outline-primary" runat="server" OnClick="btnVerUsuarios_Click" Text="Ver Usuarios inscriptos" />
                    <asp:Label ID="lblCantUsuarios" runat="server" text="" ></asp:Label>
         
                    <asp:Button ID="btnEliminarUsuarios" CSSclass="btn btn-outline-danger" Text="Eliminar Usuario" runat="server" />
